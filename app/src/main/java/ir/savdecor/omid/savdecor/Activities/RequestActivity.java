...
public class RequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new_request.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NewRequestFragment fragmentEditProfile = new NewRequestFragment();
                FragmentTransaction t = getSupportFragmentManager().beginTransaction();
//                t.setCustomAnimations(R.anim.inter_anime, R.anim.exit_to_left_);
                t.replace(R.id.fragment_new_request_id, fragmentEditProfile);
                t.commit();
        ...
        recyclerView = findViewById(R.id.rcv_request_list_id);
...
//        recyclerView.setNestedScrollingEnabled(false);
        ...
        getMyRequest(getApplicationContext());
    }

    public void getMyRequest(final Context context) {

        RequestQueue queue = Volley.newRequestQueue(context);
        StringRequest postRequest = new StringRequest(Request.Method.GET, Helper.basUrl + "api/my_requests",
...
//        postRequest.setShouldCache(false);
        ...
        if (Helper.internetIsConnected()) {
            queue.getCache().remove(Helper.basUrl + "api/my_requests");
        }
